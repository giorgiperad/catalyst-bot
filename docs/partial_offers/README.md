...
This folder bundles the design / reference / planning material for the CHIP-0052 partial-offers integration. **Nothing here is live code** — the implementation has not yet landed. See `.claude/skills/catalyst-partial-offers/SKILL.md` for the full integration skill.
