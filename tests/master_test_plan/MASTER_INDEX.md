...
| 2026-04-19 | 01-06 | `[x]` | (pending) | complexity audit: 129 F-grade functions; 5 TD entries; no bugs |
...
| 01-06 | complexity audit — radon CC, flag functions >10 | `[x]` | (pending commit) |
